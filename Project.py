...
#  Dev By : BIKstl - benjamin najmi
import warnings as w
w.filterwarnings('ignore')
data = pd.read_csv("/AI-Data.csv")
ch = 0
while(ch != 10):
    print("1.Marks Class Count \t2.Marks Class Semester-wise \n3.Marks Class Gender-wise \t4.Marks Class Nationality-wise \n5.Marks Class Grade-wise \t6.Marks Class Section-wise \n7.Marks Class Topic-wise \t8.Marks Class Stage-wise \n9.Marks Class Absent Days-wise\t10.No \n")
    ch = int(input("Enter Choice: "))
    if (ch == 1):
        print("Loading ....\n")
        t.sleep(1)
        print("\tMarks Class Count ")
        axes = sb.countplot(x='Class', data=data, order=['L', 'M', 'H'])
        plt.show()
    elif (ch == 2):
        print("Loading ....\n")
        t.sleep(1)
        print("\tMarks Class Semester-wise ")
        ...
        print("Loading ..\n")
        t.sleep(1)
        print("\tMarks Class Nationality-wise ")
        fig, axesarr = plt.subplots(1, figsize=(10, 6))
        ...
        print("Loading ..\n")
        t.sleep(1)
        print("\tMarks Class Section-wise ")
        fig, axesarr = plt.subplots(1, figsize=(10, 6))
        ...
        print("Loading ..\n")
        t.sleep(1)
        print("\tMarks Class Absent Days-wise ")
        fig, axesarr = plt.subplots(1, figsize=(10, 6))
